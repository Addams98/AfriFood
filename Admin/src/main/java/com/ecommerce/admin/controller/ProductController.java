...
public class ProductController {
    ...
    public String allProducts(@PathVariable("pageNo") int pageNo, Model model, Principal principal) {
        ...
        model.addAttribute("title", "Gestion des produits");
    ...
    public String searchProduct(@PathVariable("pageNo") int pageNo,
        ...
        model.addAttribute("title", "Recherche de résultats Produits");
        model.addAttribute("size", products.getSize());
        model.addAttribute("products", products);
        model.addAttribute("currentPage", pageNo);
        model.addAttribute("totalPages", products.getTotalPages());
    ...
    public String addProductPage(Model model, Principal principal) {
        ...
        model.addAttribute("title", "Ajouter un produit");
    ...
    public String saveProduct(@ModelAttribute("productDto") ProductDto product,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("success", "Ajout d'un nouveau produit réussi !");
        } catch (Exception e) {
            e.printStackTrace();
            redirectAttributes.addFlashAttribute("error", "L'ajout d'un nouveau produit n'a pas abouti !");
        }
    ...
    public String updateProduct(@ModelAttribute("productDto") ProductDto productDto,
        ...
        try {
            ...
            e.printStackTrace();
            redirectAttributes.addFlashAttribute("error", "Erreur du serveur, veuillez réessayer !");
        }
        return "redirect:/products/0";
    }
    ...
    public String enabledProduct(Long id, RedirectAttributes redirectAttributes, Principal principal) {
        try {
            ...
            e.printStackTrace();
            redirectAttributes.addFlashAttribute("error", "Echec de l'Autorisation");
        }
        return "redirect:/products/0";
    }
    ...
    public String deletedProduct(Long id, RedirectAttributes redirectAttributes, Principal principal) {
        try {
            ...
            e.printStackTrace();
            redirectAttributes.addFlashAttribute("error", "Échec de la suppression !");
        }
        return "redirect:/products/0";
    }
}
