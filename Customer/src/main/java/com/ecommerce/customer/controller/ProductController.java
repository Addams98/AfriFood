...
public class ProductController {
    ...
    public String details(@PathVariable("id") Long id, Model model) {
        ...
        model.addAttribute("title", "Détail du produit");
        model.addAttribute("page", "Détail du produit");
    ...
    public String productsInCategory(@PathVariable("id") Long id, Model model) {
        ...
        model.addAttribute("page", "Catégorie de produit");
    ...
    public String searchProduct(@RequestParam("keyword") String keyword, Model model) {
        ...
        model.addAttribute("productViews", listView);
        model.addAttribute("categories", categoryDtos);
        model.addAttribute("title", "Rechercher des produits");
        model.addAttribute("page", "Résultat de la recherche");
        model.addAttribute("products", productDtos);
        return "products";
    }
}
