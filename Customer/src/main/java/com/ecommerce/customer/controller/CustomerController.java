...
public class CustomerController {
    ...
    public String updateProfile(@Valid @ModelAttribute("customer") CustomerDto customerDto,
       ...
       // model.addAttribute("cities", cities);
        ...
        attributes.addFlashAttribute("success", "Mise à jour réussie !");
    ...
    public String changePassword(Model model, Principal principal) {
        ...
        model.addAttribute("title", "Modifier le mot de passe");
        model.addAttribute("page", "Modifier le mot de passe");
    ...
    public String changePass(@RequestParam("oldPassword") String oldPassword,
        ...
        if (principal == null) {
            ...
            if (passwordEncoder.matches(oldPassword, customer.getPassword())
                ...
                attributes.addFlashAttribute("success", "Votre mot de passe a été modifié avec succès !");
                return "redirect:/profile";
            } else {
                model.addAttribute("message", "Votre mot de passe est erroné");
                return "change-password";
            }
        }
    }
