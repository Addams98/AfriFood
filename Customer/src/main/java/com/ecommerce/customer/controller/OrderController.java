...
public class OrderController {
    ...
    public String checkOut(Principal principal, Model model) {
        if (principal == null) {
            ...
            if (customer.getAddress() == null || /*customer.getCity() == null ||*/ customer.getPhoneNumber() == null) {
                model.addAttribute("information", "Vous devez mettre à jour vos informations avant de passer à la caisse");
    ...
    public String getOrders(Model model, Principal principal) {
        if (principal == null) {
            ...
            model.addAttribute("title", "Commance");
    ...
    public String cancelOrder(Long id, RedirectAttributes attributes) {
        ...
        attributes.addFlashAttribute("success", "Annulation de la commande réussie !");
    ...
    public String createOrder(Principal principal,
        ...
        if (principal == null) {
            ...
            model.addAttribute("title", "Détails de la commande");
            model.addAttribute("page", "Détails de la commande");
            model.addAttribute("success", "Ajout de la commande réussi");
            return "order-detail";
        }
    }
